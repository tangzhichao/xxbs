...
/**
 * A data access object (DAO) providing persistence and search support for Role entities. Transaction control of the save(), update() and delete() operations can directly support
...
public class RoleDAO {
	...
	public Role findById(java.lang.Integer id) {
		...
		try {
			Role instance = (Role) getCurrentSession().get("com.xxbs.v1.db.Role", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Role> findByExample(Role instance) {
		...
		try {
			List<Role> results = (List<Role>) getCurrentSession().createCriteria("com.xxbs.v1.db.Role").add(create(instance)).list();
	...
	public List<Role> findByParentId(Object parentId) {
	...
	public List<Role> findByKey(Object key) {
