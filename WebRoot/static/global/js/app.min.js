var App = function () {
    var t, e = !1, o = !1, a = !1, i = !1, n = [], l = "../assets/", s = "global/img/", r = "global/plugins/", c = "global/css/", d = {
    ...
    }, SignOut = function () { //退出登陆 by lzy
        $('#sign_out').click(function () {
        	if(confirm("确定要退出系统吗？")){
        		window.location.href="logout.do";
        	}
            /*$.ajax({
                "url": "/system/api/userLoginOut/",
                "type": 'POST',
                "beforeSubmit": function () {
                },
                "success": function (data) {
                    location.href = '/system/showUserLogin/';
                },
    ...
    }, editPassword = function () { //退出登陆 by lzy
        //编辑
        $(document).on('click', '#edit_password', function (e) {
            e.preventDefault();
            $('#form_edit_password').clearForm();
        ...
        $("#form_edit_password").validate({
            ...
            submitHandler: function (form) {
                //    表单提交
                $("#form_edit_password").ajaxSubmit({
                    "url": "/system/api/savePassword/",
                    "type": 'POST',
                    "dataType": 'json',
                    "beforeSubmit": function () {
                    },
